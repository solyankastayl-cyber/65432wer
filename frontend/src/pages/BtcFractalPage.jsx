    ...
    try {
      ...
      if (result.ok) {
        ...
        const transformedData = {
          ...
          currentPrice: btcData.currentPrice || 67000,
        ...
        <div className="bg-white rounded-xl p-4 mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-baseline gap-1">
              <span className="text-2xl font-semibold text-gray-900 tracking-tight">${Math.floor(data.currentPrice || 0).toLocaleString()}</span>
